---------------------------------------------------
-- Daniel Rees bluearch theme rc.lua config file --
--        http://danrees.me                      --
---------------------------------------------------
...
-- The following includes selected 'awesome-wm-widgets' from
-- https://github.com/streetturtle/awesome-wm-widgets/tree/master/logout-menu-widget
-- Follow instructions on the github to clone into the ~/.config/awesome/ directory
local batteryarc_widget = require("awesome-wm-widgets.batteryarc-widget.batteryarc")
local volume_widget = require('awesome-wm-widgets.volume-widget.volume')

-- By default the widget doesn't have a flag to change size of the power button
-- I change in the underlying widget code by adjusting the 'margin' to create
-- my space around the power button icon on my display
local logout_menu_widget = require("awesome-wm-widgets.logout-menu-widget.logout-menu")

-- Add .local directory for .desktop files
...
-- Load archblue theme
beautiful.init("~/.config/awesome/themes/archblue/theme.lua")
...
-- Add freedesktop applications menu to include all installed apps
...
mymainmenu = freedesktop.menu.build({
	before = {
		{ "Awesome", myawesomemenu, beautiful.awesome_submenu_icon },
	},
...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Removed tasklist - not used in this config but left in from default and commented out
	...
	mytextclock,
	logout_menu_widget({onlock = function () awful.spawn.with_shell("light-locker-command -l") end}),
	-- s.mylayoutbox,
},
    }
end)
...
-- {{{ Key bindings
--
-- The descriptions have been renamed into custom categories compared to default config
-- The default config includes a keybinding description for each numbered tag. It is sufficient
-- to include a description for the overall keybinding. The config sources separate keybinding
-- descriptions in the hotkeys directory
--
...
{description = "go back", group = "Awesome: Tags"}),
...
{description = "swap with next client", group = "Awesome: Client"}),
awful.key({ modkey, "Shift"   }, "k", function () awful.client.swap.byidx( -1)    end,
{description = "swap with previous client", group = "Awesome: Client"}),
awful.key({ modkey, "Control" }, "j", function () awful.screen.focus_relative( 1) end,
{description = "focus next screen", group = "Awesome: Screen"}),
awful.key({ modkey, "Control" }, "k", function () awful.screen.focus_relative(-1) end,
{description = "focus previous screen", group = "Awesome: Screen"}),
...
{description = "increase masters", group = "Awesome: Layout"}),
awful.key({ modkey, "Shift"   }, "l",     function () awful.tag.incnmaster(-1, nil, true) end,
{description = "decrease masters", group = "Awesome: Layout"}),
awful.key({ modkey, "Control" }, "h",     function () awful.tag.incncol( 1, nil, true)    end,
{description = "increase columns", group = "Awesome: Layout"}),
awful.key({ modkey, "Control" }, "l",     function () awful.tag.incncol(-1, nil, true)    end,
{description = "decrease columns", group = "Awesome: Layout"}),
...
-- Volume keys with volume widget
awful.key({}, "XF86AudioRaiseVolume", function() volume_widget:inc(5) end),
awful.key({}, "XF86AudioLowerVolume", function() volume_widget:dec(5) end),
awful.key({}, "XF86AudioMute", function() volume_widget:toggle() end),

-- Media Keys - needs playerctl installed
...
-- Brightness keys - requires xbacklight
...
{description = "Show/Hide Titlebars", group="Awesome: Client"})
)
...
-- Hide titlebars on windows by default - Shift - Mod4 - t bound to show again
